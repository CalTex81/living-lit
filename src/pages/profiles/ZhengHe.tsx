...
import { Terminal, Database, Cpu, Activity, Globe, Anchor } from 'lucide-react';
...
export default function ZhengHe() {
  const timelineEvents: TimelineEvent[] = [
    { year: "1371 CE", title: "Birth in Yunnan", description: "Born as Ma He to a Hui Muslim family in Yunnan province during the transition from Yuan to Ming." },
    { year: "1405 CE", title: "First Expedition Departs", description: "Led a massive fleet of 317 ships and 28,000 men to Champa, Java, Malacca, and India." },
    { year: "1407 CE", title: "Defeat of Chen Zuyi", description: "Destroyed a powerful pirate fleet in Palembang, securing the Malacca Strait for Ming trade." },
    { year: "1413–15 CE", title: "Fourth Voyage", description: "Reached the Persian Gulf and the Red Sea; brought back a giraffe from Africa, sparking wonder in Nanjing." },
    { year: "1421 CE", title: "Sixth Expedition", description: "Explored the East African coast further, establishing the Ming as the supreme naval power in the Indian Ocean." },
    { year: "1431 CE", title: "Final Great Voyage", description: "Embarked on the seventh voyage to restore diplomatic relations after the Yongle Emperor's death." },
    { year: "1433 CE", title: "Death at Sea", description: "Died during the return leg of the seventh voyage. Buried at sea, with a symbolic tomb erected in Nanjing." }
  ];
    ...
    <div className="min-h-screen bg-stone-950 text-stone-300 font-sans selection:bg-sky-500/30 selection:text-sky-200 relative">
      ...
      <header className="fixed top-0 left-0 right-0 h-14 bg-stone-950/80 backdrop-blur-md border-b border-stone-800 z-40 flex items-center px-6 justify-between text-xs font-mono">
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="text-sky-500/80">RECORD: ZHENG_HE</span>
        </div>
      </header>
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 px-6 overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <img
            src="/Background_Zhenge.png"
            alt="Ming Treasure Fleet Background"
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <p className="font-mono text-sm text-sky-400 font-bold tracking-wider">1371 CE</p>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            <div className="space-y-4">
              ...
              <p className="font-mono text-2xl text-stone-400 uppercase tracking-widest border-l-4 border-sky-500 pl-4 py-1">
                The Star Fleet Commander
              </p>
              <p className="text-lg text-stone-300 leading-relaxed max-w-2xl font-serif italic border-b border-stone-800 pb-6">
                A Muslim eunuch who became the greatest naval commander in Chinese history. He led seven epic voyages across the Indian Ocean to project Ming power and expand the tribute system.
              </p>
            </div>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5">
          <div className="glass-panel rounded-xl p-8 space-y-6 relative border-t-2 border-t-sky-600/60 overflow-hidden group h-full">
            ...
            <h2 className="font-mono text-xl text-sky-400 drop-shadow-[0_0_8px_rgba(56,189,248,0.5)] flex items-center gap-3">
              <span className="w-2 h-2 bg-sky-500"></span> MARITIME_STRATEGY
            </h2>
            <ul className="space-y-4 text-stone-300 font-sans text-[15px] leading-relaxed list-none">
              <li className="flex items-start gap-3 pl-1">
                ...
                <span>Commanded the <strong>Baochuan (Treasure Ships)</strong>, the largest wooden vessels ever built, measuring up to 400 feet</span>
              </li>
              <li className="flex items-start gap-3 pl-1">
                <span className="text-sky-400 text-lg leading-6 shrink-0">•</span>
                <span>Established Ming dominance in the <strong>Tribute System</strong>, securing political loyalty across Southeast Asia and Africa</span>
              </li>
              <li className="flex items-start gap-3 pl-1">
                <span className="text-sky-400 text-lg leading-6 shrink-0">•</span>
                <span>Combined commercial interests with <strong>gunboat diplomacy</strong> to suppress piracy and depose hostile rulers</span>
              </li>
              <li className="flex items-start gap-3 pl-1">
                <span className="text-sky-400 text-lg leading-6 shrink-0">•</span>
                <span>Pioneered advanced <strong>nautical cartography</strong> and celestial navigation techniques in the 15th century</span>
              </li>
              <li className="flex items-start gap-3 pl-1">
                <span className="text-sky-400 text-lg leading-6 shrink-0">•</span>
                <span>His voyages marked the peak of <strong>pre-modern globalization</strong>, connecting China to Swahili Africa and Mecca</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="lg:col-span-7">
          <Timeline events={timelineEvents} title="NAVIGATIONAL_LOG // ZHENG_HE" />
        </div>
      </section>
