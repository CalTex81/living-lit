...
import { Terminal, Database, Cpu, Activity, Globe, Heart } from 'lucide-react';
...
export default function MahatmaGandhi() {
  const timelineEvents: TimelineEvent[] = [
    { year: "1869 CE", title: "Birth in Porbandar", description: "Born Mohandas Karamchand Gandhi in a coastal town in Gujarat, British India." },
    { year: "1893 CE", title: "Arrival in South Africa", description: "Began practicing law; developed the concept of Satyagraha (truth-force) after experiencing racial discrimination." },
    { year: "1915 CE", title: "Return to India", description: "Returned home to join the Indian National Congress, advocating for peasant rights and self-rule (Swaraj)." },
    { year: "1930 CE", title: "The Salt March", description: "Led a 240-mile march to Dandi to produce salt, defying the British salt tax and mobilizing millions." },
    { year: "1942 CE", title: "Quit India Movement", description: "Launched the mass protest demanding an orderly British withdrawal from India during World War II." },
    { year: "1947 CE", title: "Indian Independence", description: "India gained independence from British rule, though Gandhi was deeply saddened by the Partition of India." },
    { year: "1948 CE", title: "Assassination", description: "Died in New Delhi; mourned globally as a symbol of peace and non-violent resistance." }
  ];
    ...
    <div className="min-h-screen bg-stone-950 text-stone-300 font-sans selection:bg-orange-500/30 selection:text-orange-200 relative">
      ...
      <header className="fixed top-0 left-0 right-0 h-14 bg-stone-950/80 backdrop-blur-md border-b border-stone-800 z-40 flex items-center px-6 justify-between text-xs font-mono">
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="text-orange-500/80">RECORD: GANDHI</span>
        </div>
      </header>
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 px-6 overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <img
            src="/Background_Mahatma Ghandi.png"
            alt="Gandhi Background"
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <p className="font-mono text-sm text-orange-400 font-bold tracking-wider">1869 CE</p>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            <div className="space-y-4">
              ...
              <p className="font-mono text-2xl text-stone-400 uppercase tracking-widest border-l-4 border-orange-500 pl-4 py-1">
              ...
              <p className="text-lg text-stone-300 leading-relaxed max-w-2xl font-serif italic border-b border-stone-800 pb-6">
                The leader of India's non-violent independence movement against British rule. His philosophy of Satyagraha has inspired movements for civil rights and freedom across the world.
              </p>
            </div>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5">
          <div className="glass-panel rounded-xl p-8 space-y-6 relative border-t-2 border-t-orange-600/60 overflow-hidden group h-full">
            ...
            <h2 className="font-mono text-xl text-orange-400 drop-shadow-[0_0_8px_rgba(251,146,60,0.5)] flex items-center gap-3">
              <span className="w-2 h-2 bg-orange-500"></span> PHILOSOPHICAL_CORE
            </h2>
            <ul className="space-y-4 text-stone-300 font-sans text-[15px] leading-relaxed list-none">
              <li className="flex items-start gap-3 pl-1">
                ...
                <span>Pioneered <strong>Satyagraha</strong>, a methodology of non-violent resistance that seeks to convert the opponent through truth and suffering</span>
              </li>
              <li className="flex items-start gap-3 pl-1">
                <span className="text-orange-400 text-lg leading-6 shrink-0">•</span>
                <span>Advocated for <strong>Swadeshi</strong> (economic self-sufficiency) and the use of hand-spun cloth (Khadi) to boycott British goods</span>
              </li>
              <li className="flex items-start gap-3 pl-1">
                <span className="text-orange-400 text-lg leading-6 shrink-0">•</span>
                <span>Fought against the social evil of <strong>untouchability</strong>, renaming those at the bottom of the caste hierarchy 'Harijans' (Children of God)</span>
              </li>
              <li className="flex items-start gap-3 pl-1">
                <span className="text-orange-400 text-lg leading-6 shrink-0">•</span>
                <span>Demonstrated the power of <strong>political fasting</strong> as a means of moral pressure on both the British and fellow Indians</span>
              </li>
              <li className="flex items-start gap-3 pl-1">
                <span className="text-orange-400 text-lg leading-6 shrink-0">•</span>
                <span>His life and teachings inspired global leaders like <strong>Martin Luther King Jr.</strong> and <strong>Nelson Mandela</strong></span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="lg:col-span-7">
          <Timeline events={timelineEvents} title="HISTORICAL_LOG // GANDHI" />
        </div>
      </section>
